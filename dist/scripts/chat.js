...
document.addEventListener('DOMContentLoaded', function () {
    electron_log_1.default.info('[renderer.js] DOM Content Loaded');
    document.getElementById('postResButton').onclick = postRes;
    document.getElementById('kakikomi').onkeydown = checkPostKey;
});
ipcRenderer.on(const_1.electronEvent.CHAT_INIT, function (event, args) {
    electron_log_1.default.info("[CHAT_INIT] " + args.boardId);
    var dom = document.getElementById('boardId');
    electron_log_1.default.info(dom);
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                if (!resMessage)
                    return [2 /*return*/];
                boardId = document.getElementById('boardId').innerHTML;
                // 書き込み
                electron_log_1.default.info("[\u66F8\u304D\u8FBC\u307F] [message] " + resMessage + " [boardId] " + boardId);
                return [4 /*yield*/, ipcRenderer.invoke(const_1.electronEvent.MAIN_POST_KAKIKOMI, { message: resMessage, boardId: boardId })];
            case 1:
                result = _a.sent();
                if (result) {
                    // テキストを初期化
...
//# sourceMappingURL=data:application/json;base64,
